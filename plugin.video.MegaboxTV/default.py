...
msg = ("https://gist.githubusercontent.com/Gunboybr/7433f8dcf45f3ff5aeec6cfce4884b01/raw/4d33fa54f688380b9cc10db17a702d2873e7f239") 
...
def GetSublinks(name,url,iconimage,fanart):
    ...
    if c==1:
        try:
         ...
         rNo=dialog.select('-=.MegaBoxTV.=- Selecione [COLOR white]Link[1][/COLOR][COLOR gold]=720P[/COLOR] ou [COLOR white]Link[2][/COLOR][COLOR gold]=1080P[/COLOR]', List)
         if rNo>=0:
             rName=name
             rURL=str(ListU[rNo])
